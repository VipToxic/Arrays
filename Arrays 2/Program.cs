    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < numbers; i++)
            {
                ...
                Console.Write($"Введите {i + 1} вое число: "); // i + 1 потому что i изначально равен к 0
            ...
            Console.WriteLine("----Массив в обраном порядке----");
            ...
            Console.WriteLine();
            Console.WriteLine("----Проверка массива на четность----");
